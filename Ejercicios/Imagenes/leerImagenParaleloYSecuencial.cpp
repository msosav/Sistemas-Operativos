...
void verMatrizSecuencial(int x1, int y1, int x2, int y2, const vector<vector<Pixel>> matrizPixeles) {
...
void verMatrizParalelo(int x1, int y1, int x2, int y2, const vector<vector<Pixel>> matrizPixeles) {
  std::cout << "Matriz de pixeles" << std::endl;
